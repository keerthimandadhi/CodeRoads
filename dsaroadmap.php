...
?>
     ...
     <body>
        <?php include 'components/user_header.php'; ?>
         ...
         <section class="roads">
             <h1 style="color: purple;text-align: center;font-size: 300%;margin-bottom: 40px;">A SIMPLE BEGINNER FRIENDLY ROADMAP TO LEARN DATA STRUCTURES AND ALGORITHMS</h1>
             <div onclick="openOverlay('roadmaps/pythonintro.html')">
                 <a>Introduction to Data Stuructures and Algorithms</a>
             </div>
             <pre>
                 |
                 |
             ...
             <div onclick="openOverlay('roadmaps/pythonio.html')">
                 <a>Trees and Binary Search Trees:</a>
             </div>
             <pre>
                 |
                 |
